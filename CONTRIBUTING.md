...
* [open an issue](https://github.com/GoogleChromeLabs/wp-native-lazyload/issues/new)
...
* visit our project on [translate.wordpress.org](https://translate.wordpress.org/projects/wp-plugins/native-lazyload) and sign in with your wordpress.org account (create one if you haven't yet)
